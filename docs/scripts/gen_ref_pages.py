...
with mkdocs_gen_files.open("api/reference.md", "w") as f:
    ...
    print("    This page contains the complete API reference extracted from the source code.", file=f)
    print("    All functions use NumPy-style docstrings with detailed parameter and return information.", file=f)
    print("", file=f)
...
category_descriptions = {
    "session": "Functions for managing the napari viewer lifecycle, GUI state, and session information.",
    "layer_management": "Functions for creating, modifying, and organizing layers in the napari viewer.",
    "viewer_controls": "Functions for controlling the camera, navigation, and display settings.",
    "utilities": "Advanced utility functions for screenshots, code execution, and package management."
}
