...
class TestEndToEndIntegration:
    ...
    async def test_init_viewer_with_local(self):
        ...
        mock_viewer.window.qt_viewer.canvas.size = Mock(return_value=Mock(width=Mock(return_value=800), height=Mock(return_value=600)))
...
class TestProxyPatterns:
    ...
    async def test_screenshot_via_proxy(self, mock_client_class):
        ...
        mock_client.call_tool.assert_called_once_with("screenshot", {"canvas_only": True})