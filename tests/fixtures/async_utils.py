...
@asynccontextmanager
async def timeout_context(seconds: float, error_message: str | None = None):
    ...
    try:
        ...
        raise asyncio.TimeoutError(msg) from err
...
class AsyncTestHelper:
    ...
    async def run_with_timeout(
        self, coro, timeout: float = 1.0, cleanup: Callable | None = None
    ) -> Any:
